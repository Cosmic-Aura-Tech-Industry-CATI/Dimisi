...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col justify-center relative overflow-hidden py-12">
      ...
      {/* Gradient Orbs */}
      <div className="absolute -top-1/4 -right-1/4 w-[800px] h-[800px] bg-purple-500/10 rounded-full blur-[150px] z-0 pointer-events-none"></div>
        ...
        >
          ...
          <div className="flex justify-center mb-8">
            <Link href="/" className="flex items-center gap-2">
              <div className="w-10 h-10 rounded bg-gradient-to-tr from-blue-500 to-purple-500 flex items-center justify-center shadow-[0_0_20px_rgba(168,85,247,0.4)]">
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-[#0a0a0a] text-gray-500 rounded-full">Or sign up with</span>
              </div>
            </div>
