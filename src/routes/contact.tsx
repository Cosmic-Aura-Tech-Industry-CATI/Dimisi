  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Contact — Dimisi Technologies" },
      {
        ...
        content: "Let's build something meaningful together. Contact Dimisi Technologies.",
      },
    ],
  }),
...
const inputClass =
  "w-full rounded-xl border border-foreground/10 bg-foreground/[0.02] px-4 py-3 text-sm text-foreground placeholder:text-foreground/30 outline-none transition-colors focus:border-foreground/30";
...
const faqs = [
  ...
  },
  {
    ...
    answer: "Yes — we're happy to sign an NDA before discussing sensitive details.",
  },
  {
    question: "Can we schedule a call instead?",
    answer: "Absolutely. Mention it in your message and we'll send scheduling options.",
  },
];
  ...
  return (
    <>
      <PageHero
        ...
        subtitle="Tell us about your project, product idea, or support needs — we'd love to hear from you."
      />
              ...
              {status === "sent" ? (
                <div className="flex flex-col items-center justify-center py-16 text-center">
                  <motion.span
                    ...
                    className="grid h-14 w-14 place-items-center rounded-full border border-foreground/20 bg-foreground/[0.04]"
                  >
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                    <div>
                      <label className="mb-2 block text-xs uppercase tracking-wider text-foreground/40">
                        Name
                      </label>
                  ...
                  <div>
                    ...
                    <input className={inputClass} placeholder="Budget, timeline, scope…" />
                  </div>
