...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "About — Dimisi Technologies" },
      {
        property: "og:description",
        content: "The mission, vision, and people behind Dimisi Technologies.",
      },
    ],
  }),
  component: AboutPage,
...
function AboutPage() {
  return (
    <>
      ...
      >
        <PillButton to="/careers" variant="secondary">
          Join Our Team
        </PillButton>
      </PageHero>
      ...
      >
        ...
        <PillButton to="/contact" variant="secondary">
          Contact Us
        </PillButton>
      </CTABand>
    </>
