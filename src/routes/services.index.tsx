  ...
  head: () => ({
    meta: [
      { title: "Services — Dimisi Technologies" },
      {
        name: "description",
        content:
          "Web, mobile, AI automation, cloud, consulting, and more. Explore Dimisi Technologies' end-to-end technology services.",
      },
      { property: "og:title", content: "Services — Dimisi Technologies" },
      {
        property: "og:description",
        content: "End-to-end technology services from strategy to launch and beyond.",
      },
    ],
  }),
