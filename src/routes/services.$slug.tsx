...
export const Route = createFileRoute("/services/$slug")({
  ...
  head: ({ params }) => {
    ...
    if (!service || !detail) {
      return {
        meta: [
          { title: "Service Not Found — Dimisi Technologies" },
    ...
    return {
      meta: [
        ...
        { name: "description", content: detail.tagline },
...
function ServiceNotFound() {
  return (
    <div className="flex min-h-[70vh] flex-col items-center justify-center px-4 text-center">
      <h1 className="text-3xl font-light text-foreground">Service not found</h1>
      <p className="mt-3 text-sm text-foreground/50">This service doesn't exist or has moved.</p>
      <div className="mt-8">
  ...
  return (
    <>
      <PageHero label="Service" title={service.title} subtitle={detail.tagline}>
        ...
        <PillButton to="/services" variant="secondary" withArrow={false}>
