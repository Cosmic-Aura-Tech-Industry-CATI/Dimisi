// Hero.tsx — Cinematic top parallax landing banner featuring centered editorial typography and dynamic scroll-triggered scale, fade, and blur transitions on a cutout portrait.
"use client";
